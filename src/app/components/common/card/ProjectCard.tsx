...
export default function ProjectCard({
  ...
  return (
    <div
      className="card relative animate-content-up overflow-hidden opacity-0 shadow-lg"
      style={{
        ...style,
      }}
      {...rest}
    >
      ...
      <div className="card-overlay absolute inset-0 flex flex-col items-center justify-center gap-3 bg-black bg-opacity-50 p-2 text-3xl font-semibold text-white opacity-0 transition-all duration-500 ease-in-out">
        ...
        <Dialog onOpenChange={(e) => setHeaderVisible?.(!e)}>
          ...
          <DialogContent className="h-fit min-w-[85vw] px-8">
        ...
        >
          ...
          >
            <div className="z-[1500] mx-auto h-fit max-h-[80vh] w-full overflow-y-scroll px-4 pb-6 pt-4 md:max-h-[70vh] md:px-8">
              ...
              <div className="z-[1500] mx-auto mt-2 flex flex-col items-center gap-2 md:gap-8 [@media_(min-width:700px)]:flex-row">
                <div className="flex h-full w-[90%] flex-col items-start gap-1 overflow-visible md:w-3/5 md:gap-3 [@media_(min-width:700px)]:w-1/2">
                  <Carousel
                ...
                <div className="flex h-full w-full flex-col items-start justify-around gap-1.5 text-base md:gap-3 [@media_(min-width:700px)]:w-1/2">
