    ...
    <div className="relative shadow-lg overflow-hidden card">
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-center gap-3 bg-black bg-opacity-50 opacity-0 p-2 font-semibold text-3xl text-white transition-all duration-500 card-overlay ease-in-out">
        ...
        <Dialog onOpenChange={(e) => setHeaderVisible?.(!e)}>
          ...
          <DialogContent className="px-8 min-w-[85vw] h-fit min-h-[70vh]">
        ...
        >
          ...
          >
            <div className="z-[1500] mx-auto px-4 md:px-8 pt-4 pb-6 w-full h-fit max-h-[80vh] md:max-h-[70vh] overflow-y-scroll">
              ...
              <div className="z-[1500] flex md:flex-row flex-col items-center gap-2 md:gap-8 mx-auto mt-2">
                <div className="flex flex-col items-start gap-1 md:gap-3 w-[90%] md:w-1/2 h-full overflow-visible">
                  <Carousel
                ...
                <div className="flex flex-col justify-around items-start gap-1.5 md:gap-3 w-full md:w-1/2 h-full text-base">
                  <div className="flex flex-col gap-[2px]">
                    ...
                    <p
                      className="text-neutral-700 text-sm md:text-base dark:text-neutral-300"
                      dangerouslySetInnerHTML={{
                        __html: data.description[language],
                      }}
                    />
